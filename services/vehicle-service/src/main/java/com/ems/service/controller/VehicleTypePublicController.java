...
@RestController
@RequestMapping("/api/v1/public/vehicle/vehicle-types")
public class VehicleTypePublicController {

    private final VehicleTypeService vehicleTypeService;

    public VehicleTypePublicController(VehicleTypeService vehicleTypeService) {
